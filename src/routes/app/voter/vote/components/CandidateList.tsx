...
const CandidateList: React.SFC<IListProps> = (props) => (
  <ul className={props.classes.candidateList}>
    {props.children}
  </ul>
)
...
const CandidateInfo: React.SFC<IInfoProps & TranslateHocProps> =
  props => {
      ...
      <div className={classes.candidateInfo}>
        ...
        {props.infoUrl ?
          <div className={classes.candidateInfoSubText}>
            <Link to={candidate.informationUrl} external={true}>
...
const ListItemDesktopButtons: React.SFC<IDesktopButtonsProps> = props =>
  <div className={props.classes.desktopButtonsContainer}>
    <div className={props.classes.desktopButtons}>
      {props.children}
    </div>
  </div>
