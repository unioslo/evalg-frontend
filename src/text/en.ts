export default {
  admin: {
    ...
    errors: {
      ...
      backend: {
        unknown:
          'An unknown error occurred while uploading or activating the public key.',
  ...
  census: {
    ...
    uploadSuccessful:
      'Added {{numOk}} persons to the group “{{pollbookName}}“.',
    uploadSuccessfulWithFailures:
      'Added {{numOk}} persons to the group “{{pollbookName}}“. {{numFailed}} rows from the census file were discarded, probably because they already were in the census.',
    usernameOrBirthNumber: 'Username or birth number',
    errors: {
      backend: {
        unknown:
          'An unexpected error occurred while uploading or parsing the census file.',
        pollbookNotFound: 'The group no longer exists.',
        unsupportedFileType:
          'An error occured while parsing the census file. It contains invalid data, or the file type “{{mimetype}}“ is unsupported.',
      },
    },
  },
  election: {
