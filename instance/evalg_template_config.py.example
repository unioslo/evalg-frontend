# coding: utf-8
ou_tags = ['root', 'faculty', 'institute']

election_name_prefixes = {
    'root': {
        'leader': {
            'nb': 'Rektorvalg ved {}',
            'nn': 'Rektorvalg ved {}',
            'en': 'Principal election at {}'
        },
        'board': {
            'nb': 'Styrevalg ved {}',
            'nn': 'Styrevalg ved {}',
            'en': 'Board election at {}'
        },
        'parliament': {
    ...
    'institute': {
        ...
        'leader': {
            'nb': 'Instituttledervalg ved {}',
            'nn': 'Instituttledervalg ved {}',
            'en': 'Institute leader election at {}'
        },
    },
}
